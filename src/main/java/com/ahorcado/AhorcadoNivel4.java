 ...
 * @author jcaba
 */
public class AhorcadoNivel4 extends javax.swing.JFrame {

    /**
     * Creates new form AhorcadoNivel4
     */
    ...
    public AhorcadoNivel4() {
        ...
        palabras[1] = "el futuro".toUpperCase();
        palabras[2] = "la eternidad".toUpperCase();
        palabras[3] = "el conocimiento".toUpperCase();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AhorcadoNivel4.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AhorcadoNivel4().setVisible(true);
            }
        });
    }
