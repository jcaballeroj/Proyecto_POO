 ...
 * @author jcaba
 */
public class AhorcadoNivel5 extends javax.swing.JFrame {

    /**
     * Creates new form AhorcadoNivel5
     */
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AhorcadoNivel5.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AhorcadoNivel5().setVisible(true);
            }
        });
    }
